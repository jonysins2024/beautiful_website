...
const Dashboard = () => {
  const { role, isLoading, title } = useUserRole();
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 w-80 h-full bg-base-300 text-base-content dashboard flex-nowrap overflow-auto">
          ...
          {role === "admin" && (
            <>
              <li>
                <NavLink to="/dashboard/change-date">Change Date</NavLink>
              </li>
              <li>
                <NavLink to="/dashboard/update">Manage User Data</NavLink>
              </li>
              <li>
                <NavLink to="/dashboard/Admin_Control">Admin Control</NavLink>
              </li>
              <li>
                <NavLink to="/dashboard/Control_Post">Post Control</NavLink>
              </li>
              {/* <li>
