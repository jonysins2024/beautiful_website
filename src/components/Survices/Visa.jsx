    ...
    return (
        <div>
            ...
            <section className='flex flex-col-reverse md:flex-row justify-between md:px-[53px] px- items-center pb-2'>
                <div>
                    <p className='md:text-[53px] text-[29px]'>Visa certificate</p>
                    <p className='md:text-[23px]'>What you need to apply and manage your application, including the IRCC secure account, application status, <br /> forms and guides, offices, fees, medical exams and police checks.</p>
                </div>
            ...
            <section className='pb-6'>
                ...
                <div>
                    <div className='mt-[1em] md:px-[60px]'>
                        <p className='text-[#333333] font-bold text-[17px]'><span className='text-[20px] text-red-700'>*</span> Please Type Your Name <span className=' text-red-700'> (required)</span></p>
                    </div>
                ...
                <div>
                    <div className='mt-[1em] md:px-[60px]'>
                        <p className='text-[#333333] font-bold text-[17px]'><span className='text-[20px] text-red-700'>*</span> Please Type Your Passport Number <span className=' text-red-700'> (required)</span></p>
                    </div>
                    <div className='w-[91%] mx-auto'>
                        <div className='flex gap-x-3'>
