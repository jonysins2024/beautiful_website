    ...
    return (
        <div>
            ...
            <section className='flex flex-col-reverse md:flex-row justify-between md:px-[53px] px- items-center pb-2'>
                <div>
                    <p className='md:text-[53px] text-[29px]'>My LIMA certificate</p>
                    <p className='md:text-[23px]'>What you need to apply and manage your application, including the IRCC secure account, application status, forms and guides, offices, fees, medical exams and police checks.</p>
                </div>
